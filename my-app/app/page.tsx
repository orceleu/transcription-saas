  ...
  return (
    <main>
      ...
      <div className=" flex min-h-screen flex-col items-center justify-between  ">
          ...
          <div className="bg-gridline w-full p-10">
            ...
            <div className="flex justify-center">
              <p className="text-center text-gray-600 max-w-[700px] my-10">
                ...
                audio. Just choose your file, press Transcribe, and its
                complete.
              </p>
            </div>
          </div>
        </div>
        <div className=" p-5 md:p-24 w-full">
          ...
          <div className="grid gap-5 grid-cols-1 lg:grid-cols-2">
            <div>
              ...
              <p className="text-gray-600 text-center my-5 md:my-10">
                ...
                you top-up on your account, the more you will save. No plans, no
                packages, no commitments required.
              </p>{" "}
              <div className="flex justify-center  h-[150px]">
                <div className="grid grid-cols-3 gap-2 ">
                  <div className="w-[120px] lg:w-[150px] hover:bg-gray-200 h-[80px] bg-gray-100 rounded-lg border-amber-600 border-[2px]">
                  ...
                  <div className="w-[120px] lg:w-[150px] h-[80px] bg-gray-100 hover:bg-gray-200 rounded-lg border-gray-400 border-[2px]">
                    <div className="flex justify-center p-2">
                      <div className="grid gap-1">
                        <strong>5$</strong>
                        <p>2 Hours</p>
        ...
        <div className="w-full p-5 md:p-24  my-10 bg-slate-100 ">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 my-[40px]">
            ...
            <div className="w-full p-10 md:h-full bg-white rounded-lg">
            ...
            <div className=" flex justify-center w-full  bg-white rounded-lg ">
              <div>
                ...
                <div className="grid gap-3 p-10">
                  <div className="flex justify-center">
                    <ArrowLeftCircle className="text-violet-500 size-[40px]" />
                  </div>
                  <p className="text-center text-2xl font-bold">Accuracy</p>
                  <p className="text-center  ">
                    Get accurate language transcriptions, even if your video or
                    audio contains multiple languages.
                  </p>{" "}
                </div>
              </div>
            </div>
            ...
            <div className=" flex justify-center w-full  bg-white rounded-lg ">
              <div>
                ...
                <div className="grid gap-3 p-10">
                  ...
                  <p className="text-center  ">
                    Utilise Speaker Identification for precise speaker labelling
                    in your audios and videos.
                  </p>{" "}
                </div>
              </div>
            </div>
            ...
            <div className=" flex justify-center w-full  bg-white rounded-lg ">
              <div>
                ...
                <div className="grid gap-3 p-10">
                  ...
                  <p className="text-center  ">
                    Upload files in popular formats and download transcriptions
                    in various layouts, including timestamped.
                  </p>{" "}
                </div>
              </div>
            </div>
            <div className=" flex justify-center w-full  bg-white rounded-lg ">
              <div>
                ...
                <div className="grid gap-3 p-10">
                  ...
                  <p className="text-center text-2xl font-bold">Dashboard.</p>
                  <p className="text-center  ">
          ...
          <div className="grid md:grid-cols-2  gap-5 md:gap-10 ">
            <div className="bg-white shadow-md rounded-md w-full p-5 md:p-10">
              ...
              <p>
                ...
                aliquam enim soluta dolor nam, consequatur illum nobis,
                asperiores perferendis modi repellat! Nobis odio enim adipisci
                voluptate obcaecati incidunt ipsam illo!
              </p>
            </div>
            <div className="bg-white shadow-md rounded-md w-full p-5 md:p-10">
              <div className="flex justify-between my-3 ">
